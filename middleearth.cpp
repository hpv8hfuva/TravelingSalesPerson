...
/** @brief This is an array of string names. These names are all the names of the cities that will be utilized in middeearth.
 */
...
/** @brief This is the destructor for middle earth that takes in 4 parameters.
 * it deletes the array of distances and carries no return type
 *
 */
...
/** @brief This prints out the city names, total number of cities, and there x and y coordinates
 *
 */
...
/** @brief This prints out the table of the map. It prints out the distances between each possible city pair.
 */
...
/** @brief This method will take in two city names and will calculate the distances between two cities.
 *
 *
 * @param city1 The first cities used to compare the distance between the second city
 * @param city2 The second city used to compare the distances between itself and the first city
 * @return float that is the distances between two passed cities
 */
...
/** @brief This method will take in the length and try to return a random list of cities needed to travel to
 *
 *
 * @param length is the number of cities that will be put into your itinerary
 * @return vector<string> it will return the list of cities needed to travel to
 */
